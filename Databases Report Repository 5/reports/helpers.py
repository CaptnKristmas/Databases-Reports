...
def create_db_wrapper(config_map):
    ...
    if errors:
        ...
        try:
            ...
            # Simple test query — portable across DBs
            ...
            print(f"Database driver not found: {e}")
        except OperationalError as e:
            print(f"Operational error - from mysql:\n{e}")
            print(f"*** Check your .env file for correct values ***")
        except Exception as e:
            print(f"Unexpected error: {e}")
        finally:
            if 'cnx' not in locals() or cnx is None:
                print("*** ALL SUBSEQUENT SQL CALLS WILL FAIL!!! ***")
    return cnx, config
